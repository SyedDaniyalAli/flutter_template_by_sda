...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl(
      {required this.searchResponse, required this.searchByDefinition});

  @override
  final AsyncValue<List<SearchModel>> searchResponse;
  @override
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, searchResponse, searchByDefinition);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {required final AsyncValue<List<SearchModel>> searchResponse,
      required final bool searchByDefinition}) = _$HomeStateImpl;
